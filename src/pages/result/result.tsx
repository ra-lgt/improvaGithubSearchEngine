            ...
            <Card.Root key={user_data.login} className="relative">
              ...
              <Card.Footer justifyContent="flex-end">
                <Button
                  variant="outline"
                  onClick={() => {
                    handleViewUser(user_data?.login);
                  }}
                >
                  View Profile
                </Button>
